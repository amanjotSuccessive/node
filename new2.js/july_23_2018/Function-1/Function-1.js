// PLEASE CALL ME IF YOU ARE READING THIS CODE
...
addChoice = (subDivId) => {
    ...
    let br = document.createElement('br');
    br.setAttribute('class', subDivId+addChoiceCount);

    let labelElement = document.createElement('label');
    labelElement.setAttribute('class', subDivId+addChoiceCount);
    labelElement.innerHTML = "&emsp;Choice : ";
    
    let inputElement = document.createElement('input');
    inputElement.setAttribute('type', 'text');
    inputElement.setAttribute('class', subDivId+addChoiceCount);
    
    let selectedLabel = document.createElement('label');
    selectedLabel.innerHTML = " &emsp; Selected?"
    selectedLabel.setAttribute('class', subDivId+addChoiceCount);
    
    let selectedLabelCheckBox = document.createElement('input');
    selectedLabelCheckBox.setAttribute('type', 'checkbox');
    selectedLabelCheckBox.setAttribute('class', subDivId+addChoiceCount);
    ...
    optionDeleteButton.setAttribute('class', subDivId+addChoiceCount);
    console.log("delete choice class :",subDivId+addChoiceCount);
    ...
    //console.log("Start :",optionDeleteButton.className,"subDelete class");
...
deleteDivClass = (Class) => {
    ...
    //    console.log("removing : ",i, element[i] );  
    //    element[i].remove(); 
    //}
